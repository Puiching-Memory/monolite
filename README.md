...
| windows | Cmake              | [download](https://github.com/Kitware/CMake/releases/download/v3.30.5/cmake-3.30.5-windows-x86_64.msi) | 已测试3.30.5~3.31.6           |
| windows | MSbuild            | 通过VS2022下载                                                                                      |                               |
| windows | MSVC               | 通过VS2022下载                                                                                      | 已测试19.42.34433~            |
...
```
python tools\test.py --cfg C:\workspace\github\monolite\experiment\monolite_YOLO11_centernet
```
...
| type       | name             | url                                                 | title                                                                    |
| ---------- | ---------------- | --------------------------------------------------- | ------------------------------------------------------------------------ |
| CVPR 2021  | MonoDLE          | [github](https://github.com/xinzhuma/monodle)          | Delving into Localization Errors for Monocular 3D Object Detection       |
| 3DV  2024 | MonoLSS          | [github](https://github.com/Traffic-X/MonoLSS/)        | Learnable Sample Selection For Monocular 3D Detection                    |
| AAAI 2020  | TTFNet           | [github](https://github.com/ZJULearning/ttfnet)        | Training-Time-Friendly Network for Real-Time Object Detection            |
| community  | kitti_object_vis | [github](https://github.com/kuixu/kitti_object_vis)    | KITTI Object Visualization (Birdview, Volumetric LiDar point cloud )     |
| community  | mmdet3d          | [github](https://github.com/open-mmlab/mmdetection3d)  | OpenMMLab's next-generation platform for general 3D object detection.    |
| community  | ultralytics      | [github](https://github.com/ultralytics/ultralytics)   | YOLOv8/v11+v9/v10                                                        |
| community  | netron           | [web](https://netron.app/)                             | Visualizer for neural network, deep learning and machine learning models |
| community  | mkdocs-material  | [github](https://github.com/squidfunk/mkdocs-material) | Documentation that simply works                                          |
